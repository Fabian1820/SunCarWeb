        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              className="w-full border border-gray-300 rounded-md px-3 py-2 bg-white hover:border-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-colors"
              required
            >
