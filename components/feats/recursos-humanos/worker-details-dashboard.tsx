...
import { User, Briefcase, DollarSign, Calendar, TrendingUp, Utensils, XCircle, Building2, Building } from "lucide-react"
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{sedeNombre || "No asignada"}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{departamentoNombre || "No asignado"}</p>
              </div>
            </div>
          </div>
        </CardContent>
