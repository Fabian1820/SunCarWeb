...
interface ListaPlanificacionesTableProps {
  ...
  onCrearNueva: () => void;
  onAgregarTrabajoAPlanificacion: (planificacion: PlanificacionDiaria) => void;
...
export function ListaPlanificacionesTable({
  ...
  onVerPlanificacion,
  onCrearNueva,
  onAgregarTrabajoAPlanificacion,
  onRecargar,
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {[...planificaciones]
              ...
              const trabajosEnriquecidos = trabajosPorPlanificacion[planificacion.id || ""] || [];
              const trabajosBase: TrabajoConInfo[] = (planificacion.trabajos || []).map((trabajo) => ({
                trabajo,
                nombre: trabajo.contacto_id,
              ...
              const trabajos =
                trabajosEnriquecidos.length > 0 ? trabajosEnriquecidos : trabajosBase;
                  ...
                  <div
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter" || e.key === " ") {
                        e.preventDefault();
                        void toggleExpanded(planificacion.id || "");
                      }
                    }}
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3 mt-2">
                          ...
                          <Button
                            ...
                            size="sm"
                            variant="outline"
                            className="h-7 border-purple-300 text-purple-700 hover:bg-purple-50"
                            onClick={(e) => {
                              e.stopPropagation();
