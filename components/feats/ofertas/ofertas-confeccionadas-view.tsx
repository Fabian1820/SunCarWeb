              ...
              <Table>
                ...
                <TableBody>
                  {ofertas.map((oferta) => {
                    ...
                    const descuentos = calcularDescuentosOferta(oferta);
                    ...
                    return (
                      <TableRow key={oferta.id}>
                        ...
                        >
                          {formatCurrency(descuentos.precioFinal)}
                        </TableCell>
                        <TableCell className="text-right">
                          {descuentos.tieneDescuento ? (
                            <div className="space-y-0.5">
                              <p className="font-semibold text-red-600">
                                - {formatCurrency(descuentos.totalDescontado)}
                              </p>
                              {descuentos.montoDescuento > 0 &&
                                descuentos.montoCompensacion > 0 && (
                                  <p className="text-[11px] leading-tight text-slate-500">
                                    Desc. {formatCurrency(descuentos.montoDescuento)}
                                    {" · "}
                                    Comp.{" "}
                                    {formatCurrency(descuentos.montoCompensacion)}
                                  </p>
                                )}
                              {descuentos.montoDescuento === 0 &&
                                descuentos.montoCompensacion > 0 && (
                        ...
                        <TableCell className="text-right font-semibold text-emerald-700">
                          {formatCurrency(descuentos.precioReal)}
                        </TableCell>
                        <TableCell>
