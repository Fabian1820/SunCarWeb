            ...
            >
              ...
              <td className="py-3 px-2">
                <div className="max-w-[130px]">
                  <Badge
                    variant="outline"
                    className="bg-blue-50 text-blue-700 border-blue-200 text-xs inline-block max-w-full truncate"
                  >
                    {material.categoria}
                  </Badge>
                </div>
                  ...
                  (() => {
                    ...
                    return marcaNombre ? (
                      <div className="max-w-[100px]">
                        <Badge
                          variant="outline"
                          className={`${colorClasses.bg} ${colorClasses.text} ${colorClasses.border} text-xs inline-block max-w-full truncate`}
                        >
                          {marcaNombre}
                        </Badge>
                      </div>
                      ...
                      <Badge
                        variant="outline"
                        className={`${colorClasses.bg} ${colorClasses.text} ${colorClasses.border} text-xs`}
                      >
