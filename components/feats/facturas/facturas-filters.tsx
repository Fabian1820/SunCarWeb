...
import type { FacturaFilters, EstadoFactura } from "@/lib/types/feats/facturas/factura-types"
...
export function FacturasFilters({ filters, onApplyFilters, onClearFilters }: FacturasFiltersProps) {
                ...
                <div className="flex flex-wrap items-end gap-4">
                    <div className="w-full sm:w-auto min-w-[140px] space-y-1">
                        ...
                        <Select
                            ...
                            onValueChange={(value) =>
                                setLocalFilters({ ...localFilters, mes: value ? parseInt(value) : undefined })
                            }
                    ...
                    <div className="w-full sm:w-auto min-w-[120px] space-y-1">
                        ...
                        <Select
                            ...
                            onValueChange={(value) =>
                                setLocalFilters({ ...localFilters, anio: value ? parseInt(value) : undefined })
                            }
                            disabled={!!selectedDate}
                        >
                            <SelectTrigger>
                            ...
                            <Input
                                ...
                                onChange={(e) => {
                                    ...
                                    if (value) {
                                        ...
                                        setLocalFilters({ ...localFilters, fecha_especifica: value, mes: undefined, anio: undefined })
                                    } else {
                                        setSelectedDate(undefined)
                                        setLocalFilters({ ...localFilters, fecha_especifica: undefined })
                                    }
                                }}
                    ...
                    <div className="w-full sm:w-auto min-w-[170px] space-y-1">
                        ...
                        <Select
                            ...
                            onValueChange={(value) =>
                                setLocalFilters({ ...localFilters, estado: value as EstadoFactura })
                            }
                        >
                            <SelectTrigger>
                    ...
                    <div className="flex-1 min-w-[220px] space-y-1">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setLocalFilters({ ...localFilters, nombre_cliente: e.target.value })
                            }
                        />
                    </div>
                    ...
                    <div className="flex items-center gap-2 ml-auto">
                        {hasActiveFilters && (
                            <Button variant="ghost" size="sm" onClick={handleClear} className="gap-2 text-red-600 hover:text-red-700 hover:bg-red-50">
                                <X className="h-4 w-4" />
                                Limpiar
                            </Button>
                        )}
