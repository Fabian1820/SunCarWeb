        ...
        <div className="relative">
          ...
          {open && (
            ...
            >
              ...
              {/* Pestañas por tipo. Con flex-1 se comprimían todas para caber en
                  el ancho fijo del panel; al agregar "Avisos" ya no entraban ni
                  legibles. Ahora cada una tiene su ancho natural y la fila
                  desliza horizontalmente si no caben todas. */}
                ...
                {TABS.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "shrink-0 flex items-center justify-center gap-1 px-3 py-2.5 text-[11px] font-medium whitespace-nowrap transition-colors relative",
                        isActive
