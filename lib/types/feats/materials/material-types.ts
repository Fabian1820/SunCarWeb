...
// New interfaces for category management
...
export function transformBackendToFrontend(
  catalogos: BackendCatalogoProductos[],
): Material[] {
  ...
  },
  {
    ...
    materiales: [
      ...
      },
      {
        codigo: "6423520001",
        descripcion:
          "Batería de litio para instalación solar fotovoltaica Greenheiss Solar 2,4kWh Iron",
        um: "u",
      },
    ],
  },
    ...
    materiales: [
      {
        codigo: "6601000008",
        descripcion:
          "PRY CINTA AISLANTE 20M X 19MM X 0,13MM VERDE/AMARILLO P1000",
        um: "u",
      },
      {
        codigo: "6601000003",
