...
export default function PagosClientesPage() {
  ...
  // Filtrar ofertas con pagos para vistas de "cobros por ofertas" y "todos los cobros"
  ...
  const handleViewModeChange = async (mode: ViewMode) => {
    ...
    if (mode === "anticipos-pendientes" && ofertasSinPago.length === 0) {
      ...
      (mode === "en-proceso-pago" || mode === "finales-pendientes") &&
  ...
  useEffect(() => {
    refetchOfertasSinPago();
  }, [refetchOfertasSinPago]); // Cargar datos iniciales al montar
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4 flex-wrap">
                  ...
                  <Button
                    variant={
                      viewMode === "en-proceso-pago" ? "default" : "outline"
                    }
